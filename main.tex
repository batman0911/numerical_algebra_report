...
\isthesis{
    ...
    author-name={NGUYỄN MẠNH LINH, LÊ THỊ VÂN LY}, % Separate multiple authors with commas
    ...
    % author-zip={ZIP},
    % author-city={CITY},
    principal-supervisor={Hoàng Thị Phương Thảo}, % This must be a professor
    ...
    submission-date={2022-05-01}, % The date you handed in your document: Format yyyy-mm-dd
...
\begin{document}
    ...
    \begin{content}
		...
		\input{sections/01_simple_iteration.tex}
