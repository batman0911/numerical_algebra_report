...
\isthesis{
    title={TIỂU LUẬN},
    sub-title={Phương pháp số cho đại số tuyến tính \\ 
    ...
    % author-zip={ZIP},
    % author-city={CITY},
    principal-supervisor={Phan Trung Hiếu}, % This must be a professor
    ...
    submission-date={2022-06-10}, % The date you handed in your document: Format yyyy-mm-dd
